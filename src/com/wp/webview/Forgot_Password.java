    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     // get Internet status
        ...
        if (isInternetPresent) 
        {
                ...
                web.loadUrl("https://192.168.0.103:8443/mobileweb/control/forgotpassword?setHeader=android");
              // web.loadUrl("file:///android_asset/forgotpassword.html");
        ...
        else
        {
            ...
            showAlertDialog(Forgot_Password.this, "No Internet Connection",
