...
public class Timeline extends Activity {
 ...
 // Session Manager Class
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image = (ImageView) findViewById(R.id.image_error);
        Back = (Button) findViewById(R.id.account);
     ...
     // get Internet status
        ...
        {
        	if (user_link != null && !user_link.isEmpty()) 
            {
        	
	        	web.setWebViewClient(new myWebClient());
	            web.getSettings().setJavaScriptEnabled(true);
	            web.loadUrl(user_link + "pulse.html");
        	...
        	else
        	{
        		web.setWebViewClient(new myWebClient());
                web.getSettings().setJavaScriptEnabled(true);
                web.loadUrl("file:///android_asset/pulse.html");
        ...
        else
        {
            ...
            showAlertDialog(Timeline.this, "No Internet Connection",
