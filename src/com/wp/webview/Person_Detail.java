 ...
 */
public class Person_Detail extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     // get link from share pref    
        ...
        Search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent i = new Intent(Person_Detail.this, Swipe_Menu.class);
				startActivity(i);
			}
		});
     ...
     // get Internet status
        ...
        else
        {
            ...
            showAlertDialog(Person_Detail.this, "No Internet Connection",
