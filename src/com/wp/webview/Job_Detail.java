    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     // get link from share pref    
        ...
        Search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent i = new Intent(Job_Detail.this, Swipe_Menu.class);
				startActivity(i);
			}
		});
     ...
     // get Internet status
        ...
        if (isInternetPresent) 
        {
                ...
                web.loadUrl("file:///android_asset/job-detail.html");
        ...
        else
        {
            ...
            showAlertDialog(Job_Detail.this, "No Internet Connection",
